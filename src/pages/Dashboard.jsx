...
function Dashboard() {
  ...
  const [incident, setIncident] = useState(() => {
    try {
      ...
      localStorage.removeItem("lifelink_incident");
  ...
  const handleConfirmSignal = () => {
    ...
    setTimeout(() => {
      try {
        ...
        // Find hospitals using accident GPS,
        // availability, trauma capability and severity
